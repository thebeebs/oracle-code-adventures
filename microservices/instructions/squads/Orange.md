## Welcome to the Orange Squad. Let's get ready! ##
...
[![dev](codenvy-contribute.svg)](http://OCCS_IP/dashboard/#/ide/che/Orange)
...
| [![Node](nodejs.png)](Orange.md) | [![Java](javase.png)](Orange.md) | [![PHP](php.png)](Orange.md) |
|:---:|:---:|:---:|

| Weapon        | Password     | Git Clone Command  |
| ------------- |-------------| -----|
| Node.js 1      | Handed out | ``` git clone https://lisa.jones@REPLACENode1.git Orange/Node1 ``` |
| Java SE 1     | Handed out      |   ``` git clone https://lisa.jones@REPLACEJava1.git Orange/Java1 ``` |
| Node.js 2    | Handed out | ``` git clone https://lisa.jones@REPLACENode2.git Orange/Node2 ``` |
| Java SE 2    | Handed out      |   ``` git clone https://lisa.jones@REPLACEJava2.git Orange/Java2 ``` |
| PHP | Handed out      |  ``` git clone https://lisa.jones@REPLACEPHP.git Orange/PHP ``` |
